...
type Profile struct {
	...
	// Transform takes mefs configuration and applies the profile to it
...
running MEFS on machines with public IPv4 addresses.`,
...
profile, enables discovery in local networks.`,
	...
	"test": {
		Description: `Reduces external interference of MEFS daemon, this
...
If you apply this profile after mefs init, you will need
