...
go-pkg-name=$(shell $(GOCC) list $(go-tags) github.com/memoio/go-mefs/$(1))
go-main-name=$(notdir $(call go-pkg-name,$(1)))$(?exe)
go-curr-pkg-tgt=$(d)/$(call go-main-name,$(d))
go-pkgs=$(shell $(GOCC) list github.com/memoio/go-mefs/...)
...
check_go_path:
	GOPATH="$(GOPATH)" bin/check_go_path github.com/memoio/go-mefs
.PHONY: check_go_path
