...
var StatsCmd = &cmds.Command{
	Helptext: cmds.HelpText{
		Tagline: "Query MEFS statistics.",
		ShortDescription: `'mefs stats' is a set of commands to help look at statistics
for your MEFS node.
`,
		LongDescription: `mefs stats' is a set of commands to help look at statistics
for your MEFS node.`,
	},
...
var statBwCmd = &cmds.Command{
	Helptext: cmds.HelpText{
		Tagline: "Print mefs bandwidth information.",
		ShortDescription: `'mefs stats bw' prints bandwidth information for the mefs daemon.
It displays: TotalIn, TotalOut, RateIn, RateOut.
		`,
		LongDescription: `'mefs stats bw' prints bandwidth information for the mefs daemon.
It displays: TotalIn, TotalOut, RateIn, RateOut.
...
Example:
    ...
    > mefs stats bw -t /ipfs/bitswap
    Bandwidth
    TotalIn: 5.0MB
    TotalOut: 0B
    RateIn: 343B/s
    RateOut: 0B/s
    > mefs stats bw -p QmepgFW7BHEtU4pZJdxaNiv75mKLLRQnPi1KaaXmQN4V1a
    Bandwidth
    TotalIn: 4.9MB
    TotalOut: 12MB
    RateIn: 0B/s
