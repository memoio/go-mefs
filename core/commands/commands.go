// Package commands implements the mefs command interface
//
// Using github.com/memoio/go-mefs/commands to define the command line and HTTP
// APIs.  This is the interface available to folks using MEFS from outside of
// the Go language.
package commands
...
func CommandsCmd(root *cmds.Command) *cmds.Command {
	return &cmds.Command{
		...
		Run: func(req *cmds.Request, res cmds.ResponseEmitter, env cmds.Environment) error {
			rootCmd := cmd2outputCmd("mefs", root)
