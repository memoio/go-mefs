...
// Append
func (d *ktds) Append(key ds.Key, value []byte, beginoffset, endoffset int) (err error) {
...
func (d *ktds) GetSegAndTag(key ds.Key, offset uint64) (segment []byte, tag []byte, err error) {
