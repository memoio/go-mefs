...
const (
	// PluginName is the libp2p daemon METB plugin name.
...
// NewNode creates a localp2pd metb core node that runs the libp2p daemon on the
...
// Dir returns the metb directory assigned to the node
