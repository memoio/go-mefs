...
import (
	...
	"github.com/memoio/go-mefs/source/goleveldb/leveldb/journal"
	...
	"github.com/memoio/go-mefs/source/goleveldb/leveldb/table"
...
func (db *DB) Append(key []byte, value []byte, ro *opt.WriteOptions) (err error) {
	return nil
}
