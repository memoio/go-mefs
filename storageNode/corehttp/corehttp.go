...
high-level HTTP interfaces to MEFS.
*/
package corehttp
...
type ServeOption func(*core.MefsNode, net.Listener, *http.ServeMux) (*http.ServeMux, error)

// makeHandler turns a list of ServeOptions into a http.Handler that implements
// all of the given options, in order.
func makeHandler(n *core.MefsNode, l net.Listener, options ...ServeOption) (http.Handler, error) {
...
func ListenAndServe(n *core.MefsNode, listeningMultiAddr string, options ...ServeOption) error {
...
func Serve(node *core.MefsNode, lis net.Listener, options ...ServeOption) error {
