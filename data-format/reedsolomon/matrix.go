...
// IdentityMatrix returns an identity matrix of the given size. 返回单位矩阵
...
// matrix (the one on the right) and returns a new matrix with the result.  （左）此矩阵 × （右）矩阵
...
// and nil if the matrix is square	//是否方阵
